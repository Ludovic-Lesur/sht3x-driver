...
|:---:|:---:|
| [sw2.4](https://github.com/Ludovic-Lesur/sht3x-driver/releases/tag/sw2.4) | >= [sw5.0](https://github.com/Ludovic-Lesur/embedded-utils/releases/tag/sw5.0) |
| [sw2.3](https://github.com/Ludovic-Lesur/sht3x-driver/releases/tag/sw2.3) | >= [sw5.0](https://github.com/Ludovic-Lesur/embedded-utils/releases/tag/sw5.0) |
| [sw2.2](https://github.com/Ludovic-Lesur/sht3x-driver/releases/tag/sw2.2) | >= [sw5.0](https://github.com/Ludovic-Lesur/embedded-utils/releases/tag/sw5.0) |
| [sw2.1](https://github.com/Ludovic-Lesur/sht3x-driver/releases/tag/sw2.1) | >= [sw5.0](https://github.com/Ludovic-Lesur/embedded-utils/releases/tag/sw5.0) |
| [sw2.0](https://github.com/Ludovic-Lesur/sht3x-driver/releases/tag/sw2.0) | >= [sw5.0](https://github.com/Ludovic-Lesur/embedded-utils/releases/tag/sw5.0) |
| [sw1.5](https://github.com/Ludovic-Lesur/sht3x-driver/releases/tag/sw1.5) | >= [sw5.0](https://github.com/Ludovic-Lesur/embedded-utils/releases/tag/sw5.0) |
...
cmake -DCMAKE_TOOLCHAIN_FILE="<toolchain_file_path>" \
      ...
      -DSHT3X_DRIVER_I2C_ERROR_BASE_LAST=0 \
      -DSHT3X_DRIVER_DELAY_ERROR_BASE_LAST=0 \
      -G "Unix Makefiles" ..
make all
```
